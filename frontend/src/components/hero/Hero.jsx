import {Body, Container,Title,PrimaryButton,Caption,ProfileCard} from "../../components/common/Design";
        ...
        <Container className="flex items-center justify-between md:flex-row flex-col">
            <div className="w-full md:w-1/2 text-white pr-12 mt-16">
                <Title level={3} className="text-white">
                    Build,sell and collect digital items
                </Title>
            ...
            <img src = "../images/comman/hero.webp"/>
            <div className="horiz-move absolute md:top-28 top-8 left-0">
                <Box title ="Proof of quality" desc ="lore ipsum dolar amet"/>
            </div>
            <div className="horiz-move absolute bottom-72 right-0">
                <Box title ="safe and secure" desc ="lore ipsum dolar amet"/>
            </div>
