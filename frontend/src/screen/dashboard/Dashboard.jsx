...
import { getuserProfile,getUserIncome, getAllUser } from "../../redux/features/authSlice";
import { getAllProduct, getAllProductOfUser, getAllWonProductOfUser } from "../../redux/features/productSlice";
    ...
    <>
      <section>
        <div className="shadow-s1 p-8 rounded-lg  mb-12">
          ...
          <hr className="my-5" />
          {role==="buyer" &&  <h1 className="text x1 text-center font-semibold py-8 text-green">Please become a seller</h1>} 
