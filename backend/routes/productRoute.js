...
const { createProduct,getAllProducts,getProduct, getAllSoldProducts ,deleteProduct,updateProduct,getAllProductsOfUser,getWonProducts,verifyAndCommissionProductByAdmin, getAllProductsByAmdin,deleteProductsByAmdin} = require('../controllers/productController');
